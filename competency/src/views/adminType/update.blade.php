        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <a href="javascript:void(0)" id="help_app" title="Halaman ini digunakan untuk merubahdaftar tipe kompetensi"><i class="fa fa-question-circle"></i></a>
                </header>
                <div class="panel-body">
                    ...
                    <div class="form-group @if ($errors->has('name')) has-error @endif">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="inputName" placeholder="Nama Tipe kompetensi" value="{{ $data->name }}" name="name">
